...
if(isset($_POST['submitData'])){
    ...
    $InsertQuery = "INSERT INTO users (`name`,`user_name`,`password`,`is_admin`) VALUES('$name','$userName','$password',0);";
    if(mysqli_query($con,$InsertQuery)){
        echo '<div class="alert alert-success text-center">Developer Added Successfully</div>';
