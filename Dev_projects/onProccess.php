...
$SelectQuery = "SELECT P.* FROM projects P INNER JOIN project_developers DP ON P.id=DP.project_id WHERE P.deleted IS NULL AND DP.developer_id=$Logged_id AND P.status = 1;";
                                                ...
                                                while ($fetch = mysqli_fetch_array($result)) {
                                                    echo '<tr class="even gradeC">
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="../Dev_projects/projectDetails.php?prjID=' . $fetch['id'] . '" class="btn btn-warning">Details</a>
                                                                </td>
                                                            </tr>';
                                                }
                                            }else{
